...
<body>
	...
	<div id="main">
		<!-- [3]-1 메인 사이드 -->
		<div class="mainSide">
			<a href="userMenu.jsp" class="managerEdit-item"
				style="font-size: 30px; color: black"> 쇼핑몰 매출 데이터 </a><br>
		</div>
		<!-- [3]-2 메인 센터 -->
			...
			<form action="memberDeleteAction.jsp" method="post"
			  ...
			  <%
               ...
               for (int i = 0; i < salesList.size(); i++) {
            	   totalPrice += salesList.get(i).getSalesByProduct();
               %>
						<tr>
               ...
               %>
						...
						<tr>
							<td colspan='5' style="text-align: center;">총 매출액</td>
							<td style="text-align: center;"><%=new DecimalFormat().format(totalPrice) %></td>
						</tr>
